...
from Chapter08.U08_Ex4_SyracuseSeq import *
...
def testSyracuse():
    ...
    #               should be correct data type)
    # copy line multiple times to run multiple tests (with different parameters)
    results.append(runTest('syracuse(5)', True))
    results.append(runTest('syracuse()', True))
    results.append(runTest('syracuse()', True))
    results.append(runTest('syracuse()', False))
    results.append(runTest('syracuse()', True))
    results.append(runTest('syracuse()', True))
    results.append(runTest('syracuse()', False))
    results.append(runTest('syracuse()', False))

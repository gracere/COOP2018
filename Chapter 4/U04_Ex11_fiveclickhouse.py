...
# Program Description
#
# This program create a house with five clicks of the users mouse
#
# Algorithm (pseudocode)
# create graphwin
# print description
# create something to recognize a mouse click
#       connect that to creating a rectangle(house shape)
# create a rectangle(door)
# create a square(window)
# create a triangle(roof)
# make sure that the triangle matches with the house
# Create an area where they can create the house
